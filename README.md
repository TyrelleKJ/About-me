...
I'm Tyrelle Johnson, a student pursuing a Bachlor's of Science in Information Systems Management with a growing focus on cybersecurity and information technology. 

I have hands-on experience with cybersecurity tools and concepts, including network analysis, incident response, vulnerability assessment, and threat detection. Through personal projects and labs, I have worked with tools such as Wireshark, Nmap, Splunk, Volatility, and AWS while developing skills in areas like malware analysis, digital forensics, and security operations.
